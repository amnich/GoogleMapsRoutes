...
# Priority 2: %LOCALAPPDATA%\GoogleMapsRoutes\localization.json
...
function New-WorkerPowerShell {
    ...
    Get-ChildItem function: | Where-Object {
        $_.Name -in @('Protect-SecretString', 'Unprotect-SecretString', 'Test-GoogleApiKey',
                      'Get-AddressComponentValue', 'Get-AddressCoordinates', 'Get-CarRouteData',
...
<Window
    ...
    <Window.Resources>
        ...
        <!-- Modern Dark ComboBox with Dropdown Popup Template -->
        ...
        <Style TargetType="DataGrid">
            ...
            <Setter Property="AlternatingRowBackground" Value="#162032"/>
            <Setter Property="GridLinesVisibility" Value="Horizontal"/>
            <Setter Property="HorizontalGridLinesBrush" Value="#2D3748"/>
        ...
        <Style TargetType="DataGridRow">
            ...
            <Style.Triggers>
                ...
                <Trigger Property="IsMouseOver" Value="true">
                    <Setter Property="Background" Value="#2A374A"/>
                </Trigger>
            </Style.Triggers>
        </Style>
            ...
            <Setter Property="Template">
                <Setter.Value>
                    <ControlTemplate TargetType="TabItem">
                        ...
                        <ControlTemplate.Triggers>
                            <Trigger Property="IsSelected" Value="True">
                                <Setter TargetName="TabBorder" Property="Background" Value="#2563EB"/>
                                <Setter Property="Foreground" Value="#FFFFFF"/>
                            </Trigger>
                        </ControlTemplate.Triggers>
                    </ControlTemplate>
    ...
    <Grid Margin="16">
        ...
        <!-- Header -->
        <Border Grid.Row="0" Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="14,10" Margin="0,0,0,12">
            <Grid>
                ...
                <StackPanel Orientation="Vertical">
                    <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
                        ...
                        <TextBlock Name="txtHeaderTitle" Text="Google Maps Route &amp; Map Generator" FontSize="18" FontWeight="Bold" Foreground="#F8FAFC"/>
                    </StackPanel>
                    <TextBlock Name="txtHeaderSubtitle" Text="Multi-point driving routes: Fastest, Shortest, Eco-friendly | Import JSON, CSV, Excel" FontSize="12" Foreground="#94A3B8" Margin="28,2,0,0"/>
                </StackPanel>
                <StackPanel Grid.Column="1" Orientation="Horizontal" VerticalAlignment="Center">
                    ...
                    <Button Name="btnQuickSettings" Content="⚙ API Settings" Background="#334155" Foreground="#F8FAFC" Padding="10,5" FontSize="12"/>
                </StackPanel>
            </Grid>
        </Border>
            ...
            <TabItem Name="tabItemManual" Header="📍 Manual Route">
                <Grid Margin="0,10,0,0">
                    ...
                    <ScrollViewer VerticalScrollBarVisibility="Auto" Grid.Column="0" Margin="0,0,10,0">
                        <StackPanel>
                            <Border Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="14" Margin="0,0,0,12">
                                <StackPanel>
                                    <TextBlock Name="lblManualRoutePointsHeader" Text="Route Points" FontSize="15" FontWeight="Bold" Foreground="#F8FAFC" Margin="0,0,0,10"/>

                                    <TextBlock Name="lblManualOrigin" Text="Origin (Start / A):" FontSize="12" Foreground="#94A3B8" Margin="0,0,0,4"/>
                                    <Grid Margin="0,0,0,10">
                                        ...
                                        <Button Name="btnClearManualStart" Grid.Column="1" Content="✕" Background="#334155" Padding="8,6" Margin="4,0,0,0" ToolTip="Clear"/>
                                    </Grid>

                                    <TextBlock Name="lblManualWaypoints" Text="Intermediate Stops (optional up to 25):" FontSize="12" Foreground="#94A3B8" Margin="0,0,0,4"/>
                                    <Grid Margin="0,0,0,6">
                                        <Grid.ColumnDefinitions>
                                            <ColumnDefinition Width="*"/>
                                            <ColumnDefinition Width="Auto"/>
                                    ...
                                    <Grid Margin="0,0,0,10">
                                        ...
                                        <Button Name="btnWpUp" Content="▲ Up" Background="#334155" Margin="0,0,2,0" Padding="4,4" FontSize="11"/>
                                        <Button Name="btnWpDown" Grid.Column="1" Content="▼ Down" Background="#334155" Margin="2,0,2,0" Padding="4,4" FontSize="11"/>
                                        <Button Name="btnWpRemove" Grid.Column="2" Content="✕ Remove" Background="#EF4444" Margin="2,0,2,0" Padding="4,4" FontSize="11"/>
                                        <Button Name="btnWpClear" Grid.Column="3" Content="🗑 Clear" Background="#334155" Margin="2,0,0,0" Padding="4,4" FontSize="11"/>
                                    </Grid>

                                    <TextBlock Name="lblManualDestination" Text="Destination (End / B):" FontSize="12" Foreground="#94A3B8" Margin="0,0,0,4"/>
                                    <Grid Margin="0,0,0,6">
                                        <Grid.ColumnDefinitions>
                                            <ColumnDefinition Width="*"/>
                                            <ColumnDefinition Width="Auto"/>
                                        ...
                                        <Button Name="btnClearManualEnd" Grid.Column="1" Content="✕" Background="#334155" Padding="8,6" Margin="4,0,0,0" ToolTip="Clear"/>
                                    </Grid>

                                    <TextBlock Name="lblManualRouteName" Text="Route Name / Description:" FontSize="12" Foreground="#94A3B8" Margin="0,4,0,4"/>
                            ...
                            <Border Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="14" Margin="0,0,0,12">
                                <StackPanel>
                                    <TextBlock Name="lblManualOptHeader" Text="Route Optimization" FontSize="15" FontWeight="Bold" Foreground="#F8FAFC" Margin="0,0,0,10"/>

                                    <StackPanel Orientation="Horizontal" Margin="0,0,0,10">
                                        <RadioButton Name="rbTypeFastest" Content="⚡ Fastest" IsChecked="True" Foreground="#F8FAFC" FontSize="13" Margin="0,0,16,0"/>
                                        <RadioButton Name="rbTypeShortest" Content="📏 Shortest" Foreground="#F8FAFC" FontSize="13" Margin="0,0,16,0"/>
                                        <RadioButton Name="rbTypeEco" Content="🌿 Eco" Foreground="#F8FAFC" FontSize="13"/>
                                    </StackPanel>

                                    <StackPanel Name="pnlEmission" Orientation="Vertical" Visibility="Collapsed" Margin="0,0,0,8">
                                        <TextBlock Name="lblManualEmission" Text="Vehicle Engine Type (for Eco route):" FontSize="12" Foreground="#94A3B8" Margin="0,0,0,4"/>
                                    ...
                                    <CheckBox Name="chkTrafficAware" Content="Real-time traffic awareness (Live Traffic)" Foreground="#94A3B8" FontSize="12" Margin="0,4,0,4"/>
                                </StackPanel>
                            </Border>
                    ...
                    <Grid Grid.Column="1" Margin="10,0,0,0">
                        ...
                        <Border Grid.Row="0" Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="14" Margin="0,0,0,10">
                            <Grid>
                                <Grid.ColumnDefinitions>
                                    <ColumnDefinition Width="*"/>
                                    <ColumnDefinition Width="*"/>
                                ...
                                <StackPanel Grid.Column="0">
                                    <TextBlock Name="lblHeaderDist" Text="DISTANCE" FontSize="11" FontWeight="Bold" Foreground="#94A3B8"/>
                                    <TextBlock Name="lblManualDist" Text="— km" FontSize="20" FontWeight="Bold" Foreground="#10B981"/>
                                </StackPanel>

                                <StackPanel Grid.Column="1">
                                    <TextBlock Name="lblHeaderDur" Text="DURATION" FontSize="11" FontWeight="Bold" Foreground="#94A3B8"/>
                                    <TextBlock Name="lblManualTime" Text="— min" FontSize="20" FontWeight="Bold" Foreground="#F59E0B"/>
                                </StackPanel>

                                <StackPanel Grid.Column="2">
                                    <TextBlock Name="lblHeaderType" Text="ROUTE TYPE" FontSize="11" FontWeight="Bold" Foreground="#94A3B8"/>
                                    <TextBlock Name="lblManualType" Text="Fastest" FontSize="16" FontWeight="SemiBold" Foreground="#38BDF8"/>
                                </StackPanel>

                                <StackPanel Grid.Column="3" VerticalAlignment="Center">
                                    <TextBlock Name="lblManualStatus" Text="Idle" FontSize="12" Foreground="#94A3B8" HorizontalAlignment="Right"/>
                                </StackPanel>
                            </Grid>
                        </Border>

                        <Border Grid.Row="1" Background="#0F172A" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="6" Margin="0,0,0,10">
                            <Grid>
                                <TextBlock Name="lblMapPlaceholder" Text="Map preview will appear here after route calculation..."
                                           Foreground="#64748B" FontSize="14" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                                <Image Name="imgMapPreview" Stretch="Uniform" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                            </Grid>
                        </Border>

                        <Border Grid.Row="2" Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="10">
                            <Grid>
                                <Grid.ColumnDefinitions>
                                    <ColumnDefinition Width="*"/>
                                    <ColumnDefinition Width="Auto"/>
                                ...
                                <TextBlock Name="lblGoogleUrlDisplay" Text="No generated link" Foreground="#94A3B8" FontSize="12" VerticalAlignment="Center" TextTrimming="CharacterEllipsis" Margin="0,0,10,0"/>
                                <Button Name="btnOpenGoogleMaps" Grid.Column="1" Content="🌐 Google Maps" Background="#334155" Margin="0,0,6,0" Padding="10,6" IsEnabled="False"/>
                                <Button Name="btnCopyUrl" Grid.Column="2" Content="📋 Copy Link" Background="#334155" Margin="0,0,6,0" Padding="10,6" IsEnabled="False"/>
                                <Button Name="btnSaveMapAs" Grid.Column="3" Content="💾 Save Map As..." Background="#334155" Padding="10,6" IsEnabled="False"/>
                            </Grid>
                        </Border>
                    </Grid>
                </Grid>
                ...
                <Grid Margin="0,10,0,0">
                    ...
                    <Border Grid.Row="0" Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="14" Margin="0,0,0,10">
                        <Grid>
                            ...
                            <Grid Grid.Row="0" Margin="0,0,0,10">
                                ...
                                <TextBlock Name="lblBatchInputFile" Text="Input File (JSON/CSV/XLSX):" VerticalAlignment="Center" Foreground="#94A3B8" Margin="0,0,10,0"/>
                                ...
                                <Button Name="btnReloadBatchFile" Grid.Column="3" Content="🔄 Reload" Background="#334155" Margin="6,0,0,0"/>
                            </Grid>
                            ...
                            <Grid Grid.Row="1">
                                ...
                                <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
                                    <TextBlock Name="lblBatchFileInfo" Text="No file loaded." Foreground="#94A3B8" FontSize="12"/>
                                </StackPanel>
                                <StackPanel Grid.Column="2" Orientation="Horizontal" VerticalAlignment="Center" Margin="10,0">
                                    <TextBlock Name="lblBatchDefaultRouteType" Text="Default route type:" Foreground="#94A3B8" FontSize="12" VerticalAlignment="Center" Margin="0,0,6,0"/>
                    ...
                    <TabControl Name="tabBatchSub" Grid.Row="1" Background="Transparent" BorderThickness="0">
                        <TabItem Name="tabSubInput" Header="📋 Input Data Preview">
                            <Border Background="#0F172A" BorderBrush="#334155" BorderThickness="1" CornerRadius="6" Margin="0,6,0,0">
                        ...
                        <TabItem Name="tabSubLog" Header="📝 Activity Log">
                            <Border Background="#0F172A" BorderBrush="#334155" BorderThickness="1" CornerRadius="6" Margin="0,6,0,0">
                                <TextBox Name="txtBatchLog" IsReadOnly="True" TextWrapping="Wrap"
                                         ...
                                         FontSize="12" Background="#0A0F1D" Foreground="#38BDF8"/>
                            </Border>
                        </TabItem>
                    </TabControl>

                    <Border Grid.Row="2" Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="12" Margin="0,10,0,0">
                        <Grid>
                            <Grid.ColumnDefinitions>
                            ...
                            <StackPanel Grid.Column="0" VerticalAlignment="Center">
                                <TextBlock Name="lblBatchProgressText" Text="Ready" FontSize="12" Foreground="#94A3B8"/>
                                <ProgressBar Name="pbBatchProgress" Height="14" Minimum="0" Maximum="100" Value="0" Margin="0,4,0,0" Foreground="#10B981" Background="#0F172A"/>
                            </StackPanel>
                            ...
                            <StackPanel Grid.Column="2" Orientation="Horizontal" VerticalAlignment="Center">
                                <Button Name="btnOpenOutputDir" Content="📂 Open Output Folder" Background="#334155" Margin="0,0,6,0" Padding="10,6"/>
                                <Button Name="btnExportExcel" Content="📊 Export Excel" Background="#334155" Margin="0,0,6,0" Padding="10,6"/>
                                <Button Name="btnExportCsv" Content="📄 CSV" Background="#334155" Margin="0,0,6,0" Padding="10,6"/>
                                <Button Name="btnExportJson" Content="📋 JSON" Background="#334155" Padding="10,6"/>
                            </StackPanel>
                        </Grid>
                    </Border>
                </Grid>
                    ...
                    <StackPanel MaxWidth="720" HorizontalAlignment="Left">
                        <Border Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="16" Margin="0,0,0,14">
                            <StackPanel>
                                ...
                                <TextBlock Name="lblSettingsApiDesc" Text="Required for Geocoding API, Routes API v2, and Static Maps API." FontSize="12" Foreground="#94A3B8" Margin="0,0,0,10"/>

                                <TextBlock Name="lblSettingsApiLabel" Text="API Key:" FontSize="12" Foreground="#94A3B8" Margin="0,0,0,4"/>
                                <Grid Margin="0,0,0,8">
                                    <Grid.ColumnDefinitions>
                                        <ColumnDefinition Width="*"/>
                                        <ColumnDefinition Width="Auto"/>
                                    ...
                                    <Button Name="btnToggleKeyVisibility" Grid.Column="1" Content="👁 Show" Background="#334155" Margin="6,0,0,0" Padding="10,6"/>
                                    <Button Name="btnTestApiKey" Grid.Column="2" Content="🔍 Test Key" Background="#2563EB" Margin="6,0,0,0" Padding="12,6"/>
                                </Grid>

                                <StackPanel Orientation="Horizontal" Margin="0,0,0,10">
                                    <CheckBox Name="chkRememberKey" Content="Remember securely on this computer (DPAPI CurrentUser encryption)" IsChecked="True" Foreground="#94A3B8" FontSize="12"/>
                                </StackPanel>
                        ...
                        <Border Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="16" Margin="0,0,0,14">
                            <StackPanel>
                                <TextBlock Name="lblSettingsPrefHeader" Text="Default Generation Preferences" FontSize="16" FontWeight="Bold" Foreground="#F8FAFC" Margin="0,0,0,12"/>

                                <TextBlock Name="lblSettingsDefaultRouteType" Text="Default route type:" FontSize="12" Foreground="#94A3B8" Margin="0,0,0,4"/>
                                ...
                                <TextBlock Name="lblSettingsDefaultEmission" Text="Default engine type for Eco routes:" FontSize="12" Foreground="#94A3B8" Margin="0,0,0,4"/>
                                ...
                                <TextBlock Name="lblSettingsDefaultMapSize" Text="Default dimensions for generated PNG map:" FontSize="12" Foreground="#94A3B8" Margin="0,0,0,4"/>
                                ...
                                <TextBlock Name="lblSettingsOutputDir" Text="Results Output Folder:" FontSize="12" Foreground="#94A3B8" Margin="0,0,0,4"/>
                        ...
                        <Border Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="8" Padding="16" Margin="0,0,0,14">
                            <StackPanel>
                                <TextBlock Name="lblSettingsLangHeader" Text="Language &amp; Localization" FontSize="16" FontWeight="Bold" Foreground="#F8FAFC" Margin="0,0,0,8"/>
                                <TextBlock Name="lblSettingsLangLabel" Text="Application and Google Maps API Language:" FontSize="12" Foreground="#94A3B8" Margin="0,0,0,6"/>
                                <ComboBox Name="cmbSettingsLanguage" Margin="0,0,0,10"/>
                                <StackPanel Orientation="Horizontal">
                                    <Button Name="btnOpenLangFile" Content="📂 Open Localization File (localization.json)" Background="#334155" Foreground="#F8FAFC" Padding="10,6" Margin="0,0,8,0" ToolTip="Open the external localization file to edit or add new languages"/>
                                    <Button Name="btnReloadLang" Content="🔄 Reload Languages" Background="#334155" Foreground="#F8FAFC" Padding="10,6" ToolTip="Reload language definitions from disk"/>
                                </StackPanel>
                            </StackPanel>
                        </Border>
                        ...
                        <StackPanel Orientation="Horizontal" Margin="0,0,0,10">
                            ...
                            <Button Name="btnOpenLogFile" Content="📋 OPEN LOG FILE" Background="#334155" Foreground="#F8FAFC" Padding="14,10" FontWeight="SemiBold" Margin="10,0,0,0"/>
                        </StackPanel>
                    </StackPanel>
                </ScrollViewer>
            </TabItem>
        ...
        <!-- Footer -->
        <Border Grid.Row="2" Background="#1E293B" BorderBrush="#334155" BorderThickness="1" CornerRadius="6" Padding="10,6" Margin="0,10,0,0">
            <Grid>
                <Grid.ColumnDefinitions>
                    <ColumnDefinition Width="*"/>
                    <ColumnDefinition Width="Auto"/>
                </Grid.ColumnDefinitions>
                <TextBlock Name="lblFooterStatus" Text="Ready." Foreground="#94A3B8" FontSize="12" VerticalAlignment="Center"/>
                <TextBlock Name="lblFooterVersion" Grid.Column="1" Text="Google Maps Routes v2.0" Foreground="#64748B" FontSize="12" VerticalAlignment="Center"/>
            </Grid>
        </Border>
    </Grid>
</Window>
...
# Zastosowanie DWM Dark Mode dla okna
